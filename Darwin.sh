...
brew update
brew install git iterm2 neovim ngrok ripgrep tree-sitter luajit pyenv asdf httpie jq bat tldr librsvg fx exa duff diff-so-fancy hexyl hexedit gcal lua-language-server fnm tmux helix postgresql@14
brew upgrade
